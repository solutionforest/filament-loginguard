...
class LoginGuard extends Page implements HasTable
{
     ...
     * behind the admin_page config and an optional ability.
     */
    public static function canAccess(): bool
    {
        if (! (bool) config('filament-loginguard.admin_page.enabled', true)) {
            return false;
        }

        $ability = config('filament-loginguard.admin_page.authorize');
    ...
    {
        return (bool) config('filament-loginguard.admin_page.enabled', true);
    }

    public static function getDefaultSlug(): string
    {
        return (string) (config('filament-loginguard.admin_page.slug') ?: 'login-guard');
    }

    public static function getCluster(): ?string
    {
        $cluster = config('filament-loginguard.admin_page.cluster');
    ...
    {
        return (string) (config('filament-loginguard.admin_page.navigation_label')
            ?: __('filament-loginguard::loginguard.page.navigation_label'));
    }

    public static function getNavigationIcon(): string
    {
        return (string) (config('filament-loginguard.admin_page.navigation_icon')
            ?: 'heroicon-o-shield-exclamation');
    }

    public static function getNavigationGroup(): ?string
    {
        $group = config('filament-loginguard.admin_page.navigation_group');
    ...
    {
        $sort = config('filament-loginguard.admin_page.navigation_sort');
